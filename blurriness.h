...
This piece of code implements the method described in following paper:
    Frédérique Crété-Roffet, Thierry Dolmiere, Patricia Ladret, Marina Nicolas. The Blur Effect: Perception and Estimation with a New No-Reference Perceptual Blur Metric.
